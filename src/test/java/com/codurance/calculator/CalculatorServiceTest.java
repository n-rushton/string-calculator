...
import com.codurance.calculator.parsers.TwoOperandEquation;
...
public class CalculatorServiceTest {
  ...
  public void service_invokes_operator() {
    when(mockParser.parseExpression("1 + 2"))
            .thenReturn(new TwoOperandEquation(mockAdditionOperator, List.of(1, 2)));
  ...
  public void service_invokes_parser() {
    when(mockParser.parseExpression("2 + 1"))
            .thenReturn(new TwoOperandEquation(mockAdditionOperator, List.of(2, 1)));
  ...
  public void service_return_result_of_2_add_3() {
    when(mockParser.parseExpression("2 + 3"))
            .thenReturn(new TwoOperandEquation(mockAdditionOperator, List.of(2, 3)));
  ...
  public void service_return_result_of_6_add_1() {
    when(mockParser.parseExpression("6 + 1"))
            .thenReturn(new TwoOperandEquation(mockAdditionOperator, List.of(6, 1)));
